...
export const policies: Policy[] = [
  {
    ...
    updated: '1 July 2026',
    body: [
      'Hill Store collects only what it needs to fulfil an order: your name, phone number, delivery address, and the items you’ve bought. We never sell or share this information with anyone outside what’s needed to get your order to you — our delivery riders, and the payment provider that processes your transaction.',
      ...
      'You can ask us to delete any information we hold about you at any time — message us on WhatsApp or email hello@hillstore.rw and we’ll action it within a few days.',
    ].join('\n\n'),
  },
  {
    key: 'terms',
    ...
    updated: '1 July 2026',
    body: [
      'By placing an order with Hill Store, you’re agreeing to pay the listed price plus the delivery fee shown at checkout for your zone. Prices are in Rwandan francs and can change without notice, but never after an order is confirmed.',
  ...
  },
  {
    ...
    body: [
      'Hill Store offers a 100% refund on every order — checked at your door, not weeks later. When your delivery arrives, open it in front of the rider and make sure everything is right before they leave.',
